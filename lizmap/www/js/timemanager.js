...
// ONLOADED
                ...
                if ($('#tmLayers').children().length == 0) {
                  ...
                  .click(function(){
                    ...
                    // (NOTA: non serve più perchè video è solo in modalità PiP e controllato solo da slider)
	    ...
	    // display info
            ...
            // (NOTA: non serve più perchè video è controllato da slider, ma non più il contrario con PiP)
